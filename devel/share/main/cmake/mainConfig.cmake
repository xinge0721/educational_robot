...
if("TRUE" STREQUAL "TRUE")
  set(main_SOURCE_PREFIX /home/ros/chenxu/educational_robot/src/main)
  set(main_DEVEL_PREFIX /home/ros/chenxu/educational_robot/devel)
  set(main_INSTALL_PREFIX "")
  set(main_PREFIX ${main_DEVEL_PREFIX})
else()
  set(main_SOURCE_PREFIX "")
  set(main_DEVEL_PREFIX "")
  set(main_INSTALL_PREFIX /home/ros/chenxu/educational_robot/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'main' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/ros/chenxu/educational_robot/src/main/${idir}'.  ${_report}")
    endif()
...
foreach(depend ${depends})
  ...
  _list_append_deduplicate(main_EXPORTED_TARGETS ${${main_dep}_EXPORTED_TARGETS})
endforeach()
